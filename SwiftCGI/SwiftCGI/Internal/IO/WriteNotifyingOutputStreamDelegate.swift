...
/// Defines methods that allow the user of a `WriteNotifyingOutputStream` to be notified when
/// writing begins on the stream.
protocol WriteNotifyingOutputStreamDelegate: class {
